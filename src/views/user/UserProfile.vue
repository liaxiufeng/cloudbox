        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card car-transparent">
                        <div class="card-body p-0">
                            <div class="profile-image position-relative"><img src="../../assets/images/page-img/profile.png"
                                                                              class="img-fluid rounded w-100" alt="">
                            </div>
                            <div class="profile-overly"><h4>Donatella Nobatti</h4><span>sr. Manager</span></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body"><h4 class="mb-3">Personal Profile</h4>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body text-center">
                            ...
                            <h3 class="mb-2 mt-3 text-primary">42+</h3><h4>Awards</h4></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body text-center">
                            ...
                            <h3 class="mb-2 mt-3 text-success">3+years </h3><h4>Experience</h4></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body text-center">
                            ...
                            <h3 class="mb-2 mt-3 text-warning">424+</h3><h4>Participated</h4></div>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6">
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                            <div class="card card-block card-stretch card-height">
                                <div class="card-header">
                                    <div class="header-title"><h4 class="card-title">Languages</h4></div>
                                </div>
                                <div class="card-body">
                                    <ul class="list-inline p-0 mb-0">
                                        <li>
                                            <div class="d-flex align-items-center justify-content-between mb-3"><h6>
                                                English</h6>
                                                <div class="iq-progress-bar-linear d-inline-block mt-1 w-50">
                                                    <div class="iq-progress-bar iq-bg-primary"><span class="bg-primary"
                                                                                                     data-percent="70"
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center justify-content-between mb-3"><h6>
                                                Spanish</h6>
                                                <div class="iq-progress-bar-linear d-inline-block mt-1 w-50">
                                                    <div class="iq-progress-bar iq-bg-success"><span class="bg-success"
                                                                                                     data-percent="50"
                                                                                                     style="transition: width 2s ease 0s; width: 50%;"></span>
                                                    </div>
                                                </div>
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center justify-content-between mb-3"><h6>
                                                French</h6>
                                                <div class="iq-progress-bar-linear d-inline-block mt-1 w-50">
                                                    <div class="iq-progress-bar iq-bg-info"><span class="bg-info"
                                                                                                  data-percent="65"
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="card card-block card-stretch card-height">
                                <div class="card-header">
                                    <div class="header-title"><h4 class="card-title">Social</h4></div>
                                </div>
                                <div class="card-body">
                                    <ul class="list-inline p-0 m-0">
                                        <li class="mb-3 d-flex"><span><i
                                                class="lab la-facebook-f text-primary font-size-20 mr-3"></i></span>
                                            <p class="mb-0 font-size-16 line-height">fb.me/nataliedawson</p></li>
                                        <li class="mb-3 d-flex"><span><i
                                                class="lab la-twitter text-info font-size-20 mr-3"></i></span>
                                            <p class="mb-0 font-size-16 line-height">@nataliedawson</p></li>
                                        <li class=" d-flex"><span><i
                                                class="lab la-instagram  text-danger font-size-20 mr-3"></i></span>
                                            <p class="mb-0 font-size-16 line-height">@natalietweets</p></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="card card-block card-stretch card-height">
                                <div class="card-header">
                                    <div class="header-title"><h4 class="card-title">Experience</h4></div>
                                </div>
                                <div class="card-body">
                                    <ul class="list-inline mb-0 p-0">
                                        <li class="d-flex align-items-center mb-3"><span
                                                class="bg-danger rounded-small iq-card-icon-small mr-3">1</span>
                                            <p class="mb-0 font-size-16">Software Engineer at Mathica Labs | 2018 -
                                                present</p></li>
                                        <li class="d-flex align-items-center"><span
                                                class="bg-primary rounded-small iq-card-icon-small mr-3">2</span>
                                            <p class="mb-0 font-size-16">Junior Software Engineer at Zimcore Solutions |
                                                2015 - 2018</p></li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-header">
                            <div class="header-title"><h4 class="card-title">Education Traning</h4></div>
                        </div>
                        <div class="card-body">
                            <ul class="list-inline p-0 m-0">
                                <li class="d-flex align-items-center mb-3">
                                    <div class="profile-icon iq-icon-box rounded-small bg-light svg-danger text-center">
                                        <svg width="30" height="30" viewBox="0 0 24 20" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="pl-3"><h5>South Kellergrove Junior</h5>
                                        <p class="mb-0">Junior High School | Class of 2008</p></div>
                                </li>
                                <li class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="pl-3"><h5>Milchuer College</h5>
                                        <p class="mb-0">Master of Science in Computer Science | 2015</p></div>
                                </li>
                                <li class="d-flex align-items-center mb-3">
                                    <div class="profile-icon iq-icon-box rounded-small bg-light svg-warning text-center">
                                        <svg width="28" height="26" viewBox="0 0 24 26" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="pl-3"><h5>Beechtown University</h5>
                                        <p class="mb-0">Bachelor of Science in Computer Science | 2013</p></div>
                                </li>
                                <li class="d-flex align-items-center mb-3">
                                    <div class="profile-icon iq-icon-box rounded-small  bg-light svg-success text-center">
                                        <svg width="26" height="24" viewBox="0 0 24 20" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0)">
                                    ...
                                    <div class="pl-3"><h5>South Kellergrove High</h5>
                                        <p class="mb-0">Senior High School | 2010</p></div>
                                </li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-header">
                            <div class="header-title"><h4 class="card-title">Professional Skills</h4></div>
                        </div>
                        <div class="card-body">
                            <ul class="list-inline p-0 mb-0 skill-details">
                                <li>
                                    <div class="d-flex align-items-center justify-content-between mb-4 row">
                                        <div class="col-xl-4 col-lg-5"><p class="mb-0 font-size-16">Photoshop</p></div>
                                        <div class="col-xl-8 col-lg-7">
                                            <div class="iq-progress-bar bg-primary-light mt-2"><span
                                                    class="bg-primary iq-progress progress-1" data-percent="85"><span
                                                    class="progress-text-one bg-primary">85%</span></span></div>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="d-flex align-items-center justify-content-between mb-4 row">
                                        <div class="col-xl-4 col-lg-5"><p class="mb-0 font-size-16">Illustrator</p>
                                        </div>
                                        <div class="col-xl-8 col-lg-7">
                                            <div class="iq-progress-bar bg-warning-light mt-2"><span
                                                    class="bg-warning iq-progress progress-1" data-percent="65"><span
                                                    class="progress-text-one bg-warning">65%</span></span></div>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="d-flex align-items-center justify-content-between mb-4 row">
                                        <div class="col-xl-4 col-lg-5"><p class="mb-0 font-size-16">Adobe XD</p></div>
                                        <div class="col-xl-8 col-lg-7">
                                            <div class="iq-progress-bar bg-success-light mt-2"><span
                                                    class="bg-success iq-progress progress-1" data-percent="55"><span
                                                    class="progress-text-one bg-success">55%</span></span></div>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="d-flex align-items-center justify-content-between row">
                                        <div class="col-xl-4 col-lg-5"><p class="mb-0 font-size-16">Figma</p></div>
                                        <div class="col-xl-8 col-lg-7">
                                            <div class="iq-progress-bar bg-info-light mt-2"><span
                                                    class="bg-info iq-progress progress-1" data-percent="60"><span
                                                    class="progress-text-one bg-info">60%</span></span></div>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-header">
                            <div class="header-title"><h4 class="card-title">Personal Skills</h4></div>
                        </div>
                        <div class="card-body">
                            <ul class="list-inline p-0 m-0">
                                <li class="mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ml-3"><p class="mb-0 font-size-16">Creative spirit</p></div>
                                    </div>
                                </li>
                                <li class="mb-3">
                                    <div class="d-flex align-items-center">
                                        <div class="badge  badge-light iq-number">2</div>
                                        <div class="ml-3"><p class="mb-0 font-size-16">Reliable and professional</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ml-3"><p class="mb-0 font-size-16">Time management</p></div>
                                    </div>
                                </li>
                                <li class="">
                                    <div class="d-flex align-items-center">
                                        <div class="badge  badge-light iq-number">4</div>
                                        <div class="ml-3"><p class="mb-0 font-size-16">Organized</p></div>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-header">
                            <div class="header-title"><h4 class="card-title">Contact Information</h4></div>
                        </div>
                        <div class="card-body">
                            <ul class="list-inline p-0 m-0 iq-contact-rest">
                                <li class="mb-3 d-flex"><span><i
                                        class="fas fa-map-marker-alt mr-3 font-size-20"></i></span>
                                    <p class="mb-0 font-size-16 line-height">505 West Brickyard Rd,CA,USA</p></li>
                                <li class="mb-3 d-flex"><span><i
                                        class="fas fa-phone-volume mr-3 font-size-20"></i></span>
                                    <p class="mb-0 font-size-16 line-height">+91 01234 56789</p></li>
                                <li class="mb-3 d-flex"><span><i
                                        class="fas fa-envelope-open mr-3 font-size-20"></i></span>
                                    <p class="mb-0 font-size-16 line-height"><a href="" class="__cf_email__"
                                                                                data-cfemail="b5dfdadddbf5c5c7dac5d0c7c1cc9bd6dad8">[email&#160;protected]</a>
                                    </p></li>
                                <li class="mb-3 d-flex"><a href="" class="d-flex"><i
                                        class="fas fa-link  mr-3 font-size-20"></i>
                                    <p class="mb-0 font-size-16 line-height">http://www.yourwebsitename.com </p></a>
                                </li>
                                <li class="d-flex"><span><i class="fas fa-briefcase mr-3 font-size-20"></i></span>
                                    <p class="mb-0 font-size-16 line-height">9486 Roberts St. Monroe Township.</p></li>
                            </ul>
                        </div>
                    </div>
                </div>
