            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body"><h4 class="mb-3">个人中心</h4>
                            <p class="mb-0">您可以在这个页面编辑你的资料，浏览你的成就。</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body text-center">
                            ...
                            <h3 class="mb-2 mt-3 text-primary">42+</h3><h4>成就</h4></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body text-center">
                            ...
                            <h3 class="mb-2 mt-3 text-success">3+YEAR</h3><h4>使用经历</h4></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body text-center">
                            ...
                            <h3 class="mb-2 mt-3 text-warning">424+</h3><h4>社交记录</h4></div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="row">
                        <div class="col-md-12 col-lg-8">
                            <div class="card card-block card-stretch card-height">
                                <div class="card-header">
                                    <div class="header-title"><h4 class="card-title">基本信息</h4></div>
                                </div>
                                <div class="card-body">
                                    <ul class="list-inline p-0 mb-0">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-3">
                                                ...
                                                <div>
                                                    <el-input v-model="user.username" placeholder="输入用户名"
                                                              @change="updateUserName"></el-input>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center justify-content-between mb-3">
                                                <h6>签名</h6>
                                                <div>
                                                    <el-input v-model="user.describeWord" placeholder="输入个人签名"
                                                              @change="updateDescribeWord"></el-input>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="card card-block card-stretch card-height">
                                <div class="card-header">
                                    <div class="header-title"><h4 class="card-title">头像</h4></div>
                                </div>
                                <div class="card-body">
                                    <el-upload
                                    ...
                                    <div class="pl-3 mt-2">
                                        <el-radio v-model="user.sex" label="男">男生</el-radio>
                                        <el-radio v-model="user.sex" label="女">女生</el-radio>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-12">
                            <div class="card card-block card-stretch card-height">
                                <div class="card-header">
                                    <div class="header-title"><h4 class="card-title">修改密码</h4></div>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-8">
                                                ...
                                                <li class="d-flex align-items-center mb-3">
                                                    <button type="button" class="btn btn-warning"
                                                        @click="clearPassword"><i
                                                            class="las la-trash-alt iq-arrow-left"></i>全部清空
                                                    </button>
                                                </li>
                                                <li class="d-flex align-items-center">
                                                    <button type="button" class="btn btn-success"
                                                        @click="updatePassword"><i
                                                            class="ri-bill-fill"></i>确认修改
                                                    </button>
                                                </li>
                                            </ul>
                                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            updateUserName() {
                updateUserName(this, this.user.username);
            },
            updateDescribeWord() {
                updateDescribeWord(this, this.user.describeWord);
            },
            updatePassword() {
                const password = this.changePassword.password;
                const rePassword = this.changePassword.rePassword;
                if (!password || !rePassword) {
                    this.showMsg("密码或确认密码不能为空！", 2000, "error");
                } else if (password === rePassword) {
                    updatePassword(this, password);
                } else {
                    this.showMsg("密码或确认密码不一致！", 2000, "error");
                }
                this.clearPassword();
            },
            clearPassword(){
            ...
            updateBirthday() {
                updateBirthday(this, this.user.birthday);
            },
